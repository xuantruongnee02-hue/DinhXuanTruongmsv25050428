...
const reflectionItems = [
  {
    ...
    content:
      "[Viết về những thay đổi quan trọng nhất trong phương pháp học tập của bạn sau khi học môn này. Ví dụ: Cách bạn tiếp cận bài tập, cách tổ chức thời gian, cách sử dụng công cụ số...]",
    color: "primary",
  },
  {
    icon: Sparkles,
    ...
    content:
      "[Mô tả kỹ năng số nào bạn đã tiến bộ nhiều nhất. Ví dụ: Sử dụng AI, thiết kế nội dung, tìm kiếm thông tin, làm việc nhóm online...]",
    color: "chart-1",
  },
  {
    icon: Brain,
    ...
    content:
      "[Chia sẻ những điều bạn học được khi sử dụng AI trong học tập. Ví dụ: Cách đặt prompt hiệu quả, khi nào nên/không nên dùng AI, cách kiểm chứng thông tin từ AI...]",
    color: "chart-2",
  },
  {
    icon: Shield,
    ...
    content:
      "[Viết về sự thay đổi trong nhận thức của bạn về liêm chính học thuật. Bạn hiểu thế nào về việc sử dụng AI có trách nhiệm? Ranh giới giữa tham khảo và sao chép?]",
    color: "chart-3",
  },
];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary mb-4 animate-fade-in">
            ...
            <span className="text-sm font-medium">Phản tư tổng hợp</span>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto mb-12">
          {reflectionItems.map((item, index) => {
            ...
            return (
              <Card
                key={index}
                className="bg-card border-border shadow-lg hover:shadow-xl transition-all duration-300 animate-fade-in-up"
